...
namespace Location
{
    ...
    public class LocationPlugin : IPluginInitializer
    {
        ...
        public void Initialize()
        {
            ...
            positionLayout.AddAttribute<float> ("x", 0);
            positionLayout.AddAttribute<float> ("y", 0);
            positionLayout.AddAttribute<float> ("z", 0);
            ...
            orientationLayout.AddAttribute<float>("x", 0);
            orientationLayout.AddAttribute<float>("y", 0);
            orientationLayout.AddAttribute<float>("z", 0);
            orientationLayout.AddAttribute<float>("w", 1);
